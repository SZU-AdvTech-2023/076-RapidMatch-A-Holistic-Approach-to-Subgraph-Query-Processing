...
private:
    void execute_without_index(std::string src_label, std::string dst_label, edge_relation *relation);
    void execute_with_index(std::string src_label, std::string dst_label, edge_relation *relation);
...
public:
    ...
    void execute(std::string src_label, std::string dst_label, edge_relation *relation, bool indexed);
